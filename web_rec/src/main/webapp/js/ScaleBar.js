...
_ScaleBar.prototype = {
	html : [
		'<div id="orgchartForTitaRule" class="orgchart_tita_rule" style="position:absolute;left:12px;top:10px;width:0;height:0">',
 		'	<div style="display:block;height:180px;width:13px;top:-1px;background:#E2F4FF">',
